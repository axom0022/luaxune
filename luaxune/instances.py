...
class Instance:
    ...
    def Parent(self, value):
        if self._parent:
            self._parent._children.pop(self._name, nil)
        self._parent = value
        if value:
    ...
    def GetAttribute(self, attr):
        return self._properties.get(attr, nil)
    ...
    def GetDebugId(self):
        return hex(id(self))
    def GetDebugChildren(self):
        return self.GetChildren()
    def GetDebugString(self):
        return f'{self._class_name}: {self._name}'
    def __repr__(self):
        return f'Instance({self._class_name}, {self._name})'
...
class Part(Instance):
    ...
    @RotVelocity.setter
    def RotVelocity(self, v):
        self._rot_velocity = v

class Model(Instance):
    def __init__(self):
        super().__init__('Model')
    def GetPrimaryPart(self):
        return self.FindFirstChild('PrimaryPart')
...
class Tool(Instance):
    ...
    def RequiresHandle(self):
        return self._requires_handle
    @RequiresHandle.setter
    def RequiresHandle(self, b):
        self._requires_handle = b
    @property
    def Grip(self):
        return self._grip
    @Grip.setter
...
class Player(Instance):
    ...
    @AccountAge.setter
    def AccountAge(self, age):
        self._account_age = age
    @property
    def Character(self):
